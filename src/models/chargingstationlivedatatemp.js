...
export const chargingstationlivedatatempSchema = new mongoose.Schema({
	stationid: {
...
module.exports = {
    ChargingStationLiveDataTemp: mongoose.model('ChargingStationLiveDataTemp', chargingstationlivedatatempSchema)
}
