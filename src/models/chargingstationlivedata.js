...
export const chargingstationlivedataSchema = new mongoose.Schema({
	stationid: {
...
module.exports = {
   ChargingStationLiveData: mongoose.model('ChargingStationLiveData', chargingstationlivedataSchema)
}
